...
class FriendlySender2 {
    ...
    fun queryLightingScenes() {
        ...
        RxBus.send(MockPyngSubject(MockPyngSubject.SET_PROGRESS_INDICATOR, "fetching lighting scenes in sender2..."));
        simulateReceiveLightingScenes()
    }

    private fun simulateReceiveLightingScenes() {
        RxBus.send(MockPyngSubject(MockPyngSubject.RECEIVE_LIGHTING_SCENES, "scenes from sender2"))
    }
